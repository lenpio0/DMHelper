	...
	<div class="my-8">
		...
		<ul>
			<li v-for="(buff, index) in buffs" :key="buff.id" class="p-3 my-2 bg-soft-black-2">
				...
				<button @click="openBuffEdit(buff)" class="text-white bg-gray-500 border-b-4 border-gray-700 font-medium rounded-lg text-sm py-1 text-center inline-flex items-center me-2">
