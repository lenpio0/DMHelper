            ...
            <form @submit.prevent="addBuff" class="bg-soft-black-2 flex flex-col px-2 py-4 rounded-3xl">
                ...
                <div class="my-2 mx-auto">
                    <label class="flex items-center cursor-pointer rounded py-2 border-b-4 border-soft-black-2 mx-auto">
                        <input type="checkbox" v-model="is_debuff" class="sr-only peer">
                ...
                <div class="flex justify-around py-2">
                    <button @click="closeBuffAdd" class=" bg-red-600 box-content border-b-4 border-red-800 font-medium rounded-lg text-sm w-14 h-9 justify-center px-1 text-center inline-flex left-[2.1rem] items-center">
