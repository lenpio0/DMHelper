		...
		<ul>
			<li v-for="(item, index) in items" :key="item.id" class="p-3 my-2 bg-soft-black-2">
				<div class="flex justify-between">
					...
					<button type="button" @click="deleteItem(item.id)" class="text-white bg-red-600 font-medium rounded-lg text-sm px-1 text-center inline-flex items-center me-2">
						<svg width="19px" height="16px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<button type="button" @click="openItemEdit(item)" class="text-white bg-gray-500 font-medium rounded-lg text-sm py-1 text-center inline-flex items-center me-2">
