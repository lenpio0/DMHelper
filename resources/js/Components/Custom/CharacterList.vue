            ...
            <li v-for="(character, index) in characters" :key="character.id" class="p-3 pt-4 my-2 bg-soft-black-2">
				<div class="flex justify-between">
                    <div class="flex w-5/6 justify-between border-b border-soft-white-1/25">
                        ...
                        <button @click="goToChar(character.index, character.user_id)" class="text-white bg-gray-500 border-b-4 border-gray-700 w-8 h-8 flex justify-center items-center font-medium rounded-lg text-sm py-1 relative bottom-1 text-center me-2">
                    ...
                    <button @click="deleteCharacter(character.id)" class="text-white bg-red-600 border-b-4 border-red-800 font-medium rounded-lg text-sm w-8 h-8 justify-center px-1 text-center inline-flex relative bottom-1 items-center me-2">
