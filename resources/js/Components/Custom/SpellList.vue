	...
	<div class="py-8">
		...
		<ul>
			...
			<li v-if="spells.length !== 0" v-for="(spell, index) in spells" :key="spell.id" class="p-3 my-2 bg-soft-black-2">
				...
				<button @click="openSpellEdit(spell)" class="text-white bg-gray-500 border-b-4 border-gray-700 font-medium rounded-lg text-sm py-1 text-center inline-flex items-center me-2">
