		...
		<ul>
			<li v-for="(spell, index) in spells" :key="spell.id" class="p-3 my-2 bg-soft-black-2">
				<div class="flex justify-between">
					...
					<button @click="deleteSpell(spell.id)" class="text-white bg-red-600 font-medium rounded-lg text-sm px-1 text-center inline-flex items-center me-2">
				...
				<button @click="openSpellEdit(spell)" class="text-white bg-gray-500 font-medium rounded-lg text-sm py-1 text-center inline-flex items-center me-2">
