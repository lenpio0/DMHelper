...
<template>
    <div class="z-50 fixed backdrop-blur-sm top-0 bottom-0 left-0 right-0 m-auto flex items-center justify-center bg-black/50">
        <div class="w-80 sm:w-[24rem]">
            <h2 class='text-white bg-soft-black-3 w-56 pt-2 pb-1.5 m-auto rounded-t-lg text-center text-xl font-albert font-bold'>Edit Table</h2>
            <form @submit.prevent="editTable" class="bg-soft-black-2 flex flex-col px-2 py-4 rounded-3xl">
                <input v-model="name" required class="m-3 rounded-3xl text-black">
                ...
                <div class="grid grid-cols-2">
                    ...
                    <div class="flex justify-around pb-2 pt-4">
                        <button @click="closeTableEdit" class="bg-red-600 box-content border-b-4 border-red-800 font-medium rounded-lg text-sm w-14 h-9 justify-center px-1 text-center inline-flex left-[2.1rem] items-center">
