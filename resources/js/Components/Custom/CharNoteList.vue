...
<template>
    <div class="py-8">
        ...
        <ul class="py-1">
            ...
            <li v-if="char_notes.length !== 0" v-for="(char_note, index) in char_notes" :key="char_note.id" class="p-3 my-3 bg-soft-black-2 min-h-32 flex justify-between h-full sm:px-16 md:px-32 lg:px-56 xl:px-8 2xl:px-36 border-b-4 border-soft-black-1/50">
